            ...
            <div className="pt-20 pb-20 px-4 bg-slate-800 ">
                <div className="container mx-auto text-center">
                    <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-full px-4 py-2 mb-8">
                        ...
                        <span className="text-sm text-blue-400 font-medium">FlowMind : "Where your algorithm flows — from idea to flowchart, code, and clarity."</span>
                    </div>
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-transparent leading-tight">Master DSA with
                        <br />
                        <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">FlowMind</span>
                    </h1>

                    <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                        FlowMind transforms any algorithm problem into an interactive visual experience. Get solutions in multiple programming languages with Gemini-powered AI explanations, detailed time and space complexity analysis, pros and cons of each approach, and animated step-by-step flowchart walkthroughs.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                        <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 transition transform hover:scale-105 rounded-2xl hover:to-purple-700 text-white border-0 text-lg px-8 py-6">
                            <NavLink to="/trynow" className="flex items-center space-x-2">
                                ...
                                <span>Try FlowMind Now</span>
                                <ArrowRight className="h-5 w-5" />
                            </NavLink>
                        </button>

                        <NavLink to=""><button className="bg-slate-600 text-gray-300 hover:bg-slate-900 transition transform hover:scale-105 rounded-2xl hover:text-white text-lg px-8 py-6 flex justify-center items-center">
            ...
            <footer className="bg-slate-900 border-t border-slate-800 py-12 px-4">
                <div className="container mx-auto text-center">
                    <div className="flex items-center justify-center space-x-2 mb-4">
                        ...
                        <span className="text-lg font-bold text-white">FlowMind</span>
                    </div>
